...
export declare function attachWorkDone(connection: ProgressContext, params: WorkDoneProgressParams): WorkDoneProgress;
export declare const ProgressFeature: Feature<RemoteWindow, WindowProgress>;
