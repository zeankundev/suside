...
export interface Connection<PConsole = _, PTracer = _, PTelemetry = _, PClient = _, PWindow = _, PWorkspace = _> {
     ...
     * @param handler The corresponding handler.
     */
    onPrepareRename(handler: ServerRequestHandler<TextDocumentPositionParams, Range | {
        range: Range;
        placeholder: string;
...
import { WindowProgress, WorkDoneProgress, ResultProgress } from './proposed.progress';
