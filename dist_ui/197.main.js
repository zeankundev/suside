/*! For license information please see 197.main.js.LICENSE.txt */
		...
		6197: (t, e) => {
			;(() => {
								...
								(e.fromByteArray = function (t) {
									...
									return (
										1 === n
											...
											: 2 === n && ((e = (t[i - 2] << 8) + t[i - 1]), o.push(r[e >> 10] + r[(e >> 4) & 63] + r[(e << 2) & 63] + '=')),
										o.join('')
									)
								})
							for (
								var r = [], i = [], n = 'undefined' != typeof Uint8Array ? Uint8Array : Array, o = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/', s = 0, a = o.length;
								s < a;
								++s
							)
						...
						9022: function (t, e, r) {
							...
							!(function (t, e) {
								...
								var b = function (t, e, r) {
									...
									;(h = ((((o = Math.imul(d, F)) + (n >>> 13)) | 0) + (mt >>> 26)) | 0),
										(mt &= 67108863),
										(i = Math.imul(p, z)),
								...
								(h.prototype._reset = function () {
									...
									for (var h = [], u = 0; u < i; u++) {
										...
										h[u] =
											u < 4 || c <= 4
												? d
												: f.INV_SUB_MIX[0][f.SBOX[d >>> 24]] ^ f.INV_SUB_MIX[1][f.SBOX[(d >>> 16) & 255]] ^ f.INV_SUB_MIX[2][f.SBOX[(d >>> 8) & 255]] ^ f.INV_SUB_MIX[3][f.SBOX[255 & d]]
									}
								...
								var _ = (function () {
										...
										return (
											...
											(l.diff = function (t, h, u) {
												...
												return (
													(m =
														((c = {}), (c[f] = m / 12), (c[s] = m), (c[a] = m / 3), (c[o] = (b - p) / 6048e5), (c[n] = (b - p) / 864e5), (c[i] = b / 36e5), (c[r] = b / 6e4), (c[e] = b / 1e3), c)[d] ||
														b),
													u ? m : w.a(m)
												)
											}),
						...
						5109: (t, e, r) => {
							...
							function g(t, e) {
								...
								for (e = new n(e); ; ) {
									...
									if (b((p = r.shrn(1))) && b(r) && m(p) && m(r) && s.test(p) && s.test(r)) return r
								}
							}
						},
						9993: (t, e, r) => {
									...
									if (t.x || t.y)
										return (
											'mont' === this.ec.curve.type
												...
												: ('short' !== this.ec.curve.type && 'edwards' !== this.ec.curve.type) || n(t.x && t.y, 'Need both x and y coordinate'),
							...
							;(e.BlockHash = o),
								...
								(o.prototype._pad = function () {
									...
									if (((t <<= 3), 'big' === this.endian)) {
										...
										for (
											i[n++] = 255 & t, i[n++] = (t >>> 8) & 255, i[n++] = (t >>> 16) & 255, i[n++] = (t >>> 24) & 255, i[n++] = 0, i[n++] = 0, i[n++] = 0, i[n++] = 0, o = 8;
											o < this.padLength;
											o++
										)
											i[n++] = 0
							...
							;(E.prototype.read = function (t) {
								...
								(E.prototype.pipe = function (t, e) {
									...
									function u(e) {
										...
										n('dest.write', o),
											!1 === o &&
												(((1 === i.pipesCount && i.pipes === t) || (i.pipesCount > 1 && -1 !== q(i.pipes, t))) && !h && (n('false write response, pause', i.awaitDrain), i.awaitDrain++), r.pause())
									}
									function c(e) {
							...
							t.exports = {
								destroy: function (t, n) {
									...
									return s || a
										? (n
												? n(t)
												: t && (this._writableState ? this._writableState.errorEmitted || ((this._writableState.errorEmitted = !0), process.nextTick(i, this, t)) : process.nextTick(i, this, t)),
										  this)
				...
				function i(e) {
					...
					return t[e].call(n.exports, n, n.exports, i), (n.loaded = !0), n.exports
				}
				;(i.n = t => {
				...
				;(() => {
					...
					var s = i(8893),
						...
						m = i.n(b),
						g = function (t) {
							return (0, f.normalize)(t).replace(/\\/g, '/')
						}
					const y = function (t) {
						var e = t.folderPath,
							r = t.emitter,
														...
														case 0:
															;(r = e.filePath),
																...
																g(o) === g(r) &&
																	...
																	(c = f.do('setBookmark', { instance: s, line: i - 1, ch: n - 1, element: p })))
														case 2:
														case 'end':
															return t.stop()
													}
											...
											a().mark(function t(e) {
												...
												return a().wrap(function (t) {
													for (;;)
														switch ((t.prev = t.next)) {
															case 0:
																;(r = e.filePath), (i = e.from), (n = e.to), (h = e.value), g(o) === g(r) && f.do('replaceRange', { instance: s, from: i, to: n, text: h })
															case 2:
															case 'end':
																return t.stop()
														}
									...
									action: function (t, e) {
										return (function (t) {
											var e = t.changeObj,
												...
												n = t.instance,
												o = t.directory
											if (!w || (JSON.stringify(w) != JSON.stringify(e) && '+move' !== e.origin)) {
												var s = i.do('getLine', { instance: n, line: e.from.line })
												r.emit('message', { type: 'contentModified', content: { from: { line: e.from.line, ch: 0 }, to: { line: e.to.line, ch: 9999 }, value: s, filePath: o } }), (w = e)
											}
										})({ changeObj: e, emitter: i, client: f, instance: s, directory: o })
									},
								}),
								f.do('onActive', {
									instance: s,
									action: function (t, e) {
										return (function (t) {
											var e = t.emitter,
												r = t.instance,
												i = t.directory,
												n = t.client.do('getCursorPosition', { instance: r }),
												o = n.line,
												s = n.ch
											e.emit('message', { type: 'cursorSetIn', content: { filePath: g(i), line: o, ch: s } })
										})({ changeObj: e, client: f, instance: s, directory: o, emitter: i })
									},
								})
						},
						M = function (t) {
							var e = t.emitter,
								r = t.filePath
							window.require('fs').readFile(g(r), 'UTF-8', function (t, i) {
								t ? console.error(t) : e.emit('message', { type: 'returnGetFileContent', content: { filePath: g(r), fileContent: i } })
							})
						},
						S = function (t) {
							t.emitter
							var e = t.filePath,
								r = t.fileContent
							window.require('fs').writeFile(g(e), r, function (t) {
								t && console.log(t)
							})
						}
					var E, k
					...
					var z = (function () {
						function t(e) {
							...
							!(function (t, e) {
								...
								(this.room = n),
								(this.username = o),
								(this.userid = u().generate()),
								(this.usercolor = d()({ min: 70 })),
								(this.password = (0, j.createHash)('sha256').update(s).digest()),
								(this.emitter = i),
								...
								(this.conn.onmessage = function (t) {
									...
									r.emitter.emit('room/'.concat(f), q(q({}, u), {}, { senderUsername: a, senderUserid: o, senderUsercolor: s }))
								}),
					...
					function F(t) {
						...
						s.emit('addLocalTerminalAccessory', {
							menu: function (t) {
								...
								function o() {
									;(h = !h)
										? (f.emit('message', { type: 'terminalShared', content: { terminalID: n } }),
										  (e = f.on('room/terminalOutput', function (e) {
												var r = e.data
												e.terminalID === n && t.emit('data', r)
										  })),
										  (r = f.on('room/terminalBreakLine', function (e) {
												e.terminalID === n && t.emit('breakLine')
										  })),
										  (i = t.on('write', function (t) {
												f.emit('message', { type: 'terminalUpdated', content: { data: t, terminalID: n } })
										  })))
										: (f.emit('message', { type: 'terminalUnshared', content: { terminalID: n } }), e.cancel(), r.cancel(), i.cancel())
								}
															...
															return a().wrap(function (e) {
																for (;;)
																	switch ((e.prev = e.next)) {
																		...
																		case 2:
																			return (
																				(r = e.sent), (i = r.room), (n = r.password), (s = r.username), (h = new z({ emitter: f, room: i, password: n, username: s })), (e.next = 9), h.waitToConnect()
																			)
																		case 9:
																			new o({ title: 'Joined #'.concat(i, ' as ').concat(s), content: '' }), H(f, t)
																		case 11:
																		case 'end':
																			return e.stop()
																	}
					...
					function H(t, e) {
										...
										a().mark(function t(e) {
											...
											return a().wrap(function (t) {
												for (;;)
													switch ((t.prev = t.next)) {
														case 0:
															;(r = e.senderUsername), (n = e.terminalID), i.emit('unregisterTerminalShell', { name: 'remote:'.concat(n, '@').concat(r) })
														case 2:
														case 'end':
															return t.stop()
													}
						...
						t.on(
									...
									a().mark(function e(r) {
										...
										return a().wrap(function (e) {
											for (;;)
												switch ((e.prev = e.next)) {
													case 0:
														return (i = r.folderPath), (e.next = 3), n(i)
													case 3:
														if (e.sent) {
															e.next = 5
															break
										...
										a().mark(function e(r) {
											...
											return a().wrap(function (e) {
												for (;;)
													switch ((e.prev = e.next)) {
														case 0:
															return (i = r.filePath), (e.next = 3), n(i)
														case 3:
															if (e.sent) {
																e.next = 5
																break
										...
										a().mark(function e(r) {
											...
											return a().wrap(function (e) {
												for (;;)
													switch ((e.prev = e.next)) {
														case 0:
															return (i = r.filePath), (o = r.fileContent), (e.next = 3), n(i)
														case 3:
															if (e.sent) {
																e.next = 5
																break
															...
															return e.abrupt('return')
														case 5:
															S({ emitter: t, filePath: i, fileContent: o })
														case 6:
														case 'end':
															return e.stop()
													}
											...
											return a().wrap(function (r) {
												for (;;)
													switch ((r.prev = r.next)) {
														case 0:
															;(n = i.senderUsername),
																(s = (o = q({ room: t.data.room, username: n }, e)).room),
																(a = o.username),
							...
							i.on('aTabHasBeenCreated', function (r) {
								var i = r.directory,
									n = r.client,
									o = r.instance,
									s = r.tabElement
								_(q({ emitter: t, directory: i, client: n, instance: o, tabElement: s }, e))
							})
					}
					var K = function (e, i) {
							var n = i.puffin,
								...
								panel: function () {
									...
									return n.element(
										...
										function () {
											var i = {},
												...
												u = function () {
													return Object.keys(i).map(function (e) {
														...
														return {
															label: o,
															decorator: { label: r.isMe ? 'You' : '', background: s },
															iconComp: function () {
																return n.element(
																	I ||
																		(I = t([
															...
															mounted: function (t) {
																...
																e.on('instance/connected', function (t) {
																	var e = t.room,
																		...
																		s = t.username,
																		a = t.usercolor
																	i[o] = { username: s, usercolor: a, isMe: !0 }
																	var f = u()
																	r(f), n({ label: Object.keys(f).length }), (document.getElementById('room_name').innerText = e), p().extend(m())
																	var h = p()(new Date())
																	setInterval(function () {
																	...
																	e.on('room/userJoin', function (t) {
																		var e = t.senderUserid,
																			o = t.senderUsername,
																			s = t.senderUsercolor
																		i[e] = { username: o, usercolor: s, isMe: !1 }
																		var a = u()
																		r(a), n({ label: Object.keys(a).length })
																	}),
																	e.on('room/userDisconnected', function (t) {
																		var e = t.userid
																		t.username, t.usercolor, delete i[e]
																		var o = u()
																		r(o), n({ label: Object.keys(o).length })
																	}),
																	e.on('disconnect', function () {
																		delete i[e.data.me.userid], n({ label: '0' }), r([])
																	})
															},
														},
														{
											...
											n.render(c, this.querySelector('#users'))
											var l = []
											e.on(
												'room/closedFolder',
												(function () {
																		...
																		switch ((t.prev = t.next)) {
																			case 0:
																				;(n = i.folderPath),
																					(o = i.senderUserid),
																					(s = i.senderUsername),
																					(h = new f(n, n, document.getElementById('explorer_panel'), 0, !1, null, {
																						provider: {
																														...
																														switch ((r.prev = r.next)) {
																															case 0:
																																e.once('room/returnGetFileContent', function (e) {
																																	...
																																	e.emit('message', { type: 'getFileContent', content: { filePath: g(t) } })
																															case 2:
																															case 'end':
																																return r.stop()
																														}
																											...
																											a().mark(function r(n) {
																												return a().wrap(function (r) {
																													for (;;)
																														switch ((r.prev = r.next)) {
																															case 0:
																																e.emit('message', { type: 'writeFileContent', content: { filePath: t, fileContent: i } }), n()
																															case 2:
																															case 'end':
																																return r.stop()
																														}
							...
							return i.element({ components: { Card: n.Card } })(
								...
								function () {
									new o({
										title: "Room's Code",
										component: function () {
											return i.element(T || (T = t(['<p style="user-select: all; word-break: break-all;">', '</p>'])), e.data.roomcode)
										},
